...
const Cart = () => {
  ...
  return (
    <div className="border-t pt-14">
      ...
      {cartData.length === 0 ? (
        // Display empty cart message and GIF
        <div className="flex flex-col items-center justify-center mt-10">
          ...
          <div onClick={()=>navigate('/collection')} className="">
            <button>Check Out New Products</button>
          </div>
        </div>
      ) : (
        // Display cart items
                  ...
                  <input
                    onChange={(e) =>
                      e.target.value === "" || e.target.value === "0"
                        ? null
                        : updateQuantity(item._id, item.sizes, Number(e.target.value))
                    }
            ...
            <div className="w-full sm:w-[450px]">
              ...
              <div className="w-full text-end">
                <button
                  ...
                  className="uppercase bg-black text-white text-sm my-8 px-8 py-3 active:bg-slate-700"
                >
                  Proceed to Checkout
                </button>
              </div>
